...
class OTPScreenState extends State<OTPScreen> {
  ...
  countryItem(int index) {
    ...
    //           Text(
    //             "Afganistan",
    //             style: AppTextStyle.textDetailsMedium(context, AppColorStyle.text(context)),
    //           ),
    //           const Spacer(),
    //           Text(
    //             "+21",
    //             style: AppTextStyle.textDetailsLight(context, AppColorStyle.text(context)),
    //           ),
    //         ],
    //       ),
    //     ),
    //     //Divider(color: AppColorStyle.shimmerPrimary(context),height: 1,),
    //   ],
    // );
  }
