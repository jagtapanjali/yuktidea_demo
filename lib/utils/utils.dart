...
class Utility {
  ...
  static Future<Uint8List> compressImageList({
    required Uint8List imageList,
    int quality = 25,
    int minWidth = 1920,
    int minHeight = 1080,
  }) async {
    var resultList = await FlutterImageCompress.compressWithList(imageList, quality: quality, minWidth: minWidth, minHeight: minHeight);
    return resultList;
  }
  ...
  static Future<Uint8List?> compressImageFile({
    ...
    var resultList = await FlutterImageCompress.compressWithFile(Uri.encodeFull(image.absolute.path), quality: quality, minWidth: minWidth, minHeight: minHeight);
    return resultList;
  }
