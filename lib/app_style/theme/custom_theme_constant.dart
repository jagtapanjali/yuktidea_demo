...
class ThemeConstant {
  //Light theme
  static const primary = Color(0xFFD9896A);
  static const primaryBackground = Color(0xFFF5F5F5);
  static const primaryVariant = Color(0xFFF7BCA2);
  static const primaryVariant2 = Color(0xFFD85625);
  static const primaryVariant3 = Color(0xFF8E4328);
  ...
  // Dark theme
  static const primaryDark = Color(0xFFD9896A);
  static const primaryBackgroundDark = Color(0xFF292929);
  static const primaryVariantDark = Color(0xFFF7BCA2);
  static const primaryVariant2Dark = Color(0xFFD85625);
  ...
  static const textSpecialDark = Color(0xFFD2D2D2);
